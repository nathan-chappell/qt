...
public:
    ...
    virtual void beginSectionOutline(const QString &text, const QString &anchor, bool bold, bool italic, double r, double g, double b) {Q_UNUSED(text); Q_UNUSED(anchor);}
